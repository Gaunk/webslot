                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                             <?php foreach ($users_games as $key): ?>
                                                 
                                             
                                            <tr>
                                                <td><?= $key['judul_sub_menu_games'] ?></td>
                                                <td><?= $key['nama_games'] ?></td>
                                                <td>
...
<div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <!-- Modal 1 -->
                                                <div class="modal fade" id="data1Modal" tabindex="-1" role="dialog" aria-labelledby="data1ModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="gamesModalLabel">ASAL</h5>
                                                            ...
                                                            <div class="modal-body">
                                                               <ul>
                                                                <li>Jenis Rekening : <strong class="text-primary">BCA</strong></li>
                                                                <li>Nama Rekening : <strong class="text-primary">Demo</strong></li>
                                                                <li>Nomor Rekening : <strong class="text-primary">12345678</strong></li>
                                                            </ul>
                                                            </div>
                                                           <!--  -->
                                                        </div>
 ...
 <!-- Modal 2 -->
                                                <div class="modal fade" id="data2Modal" tabindex="-1" role="dialog" aria-labelledby="data2ModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <form action="#" id="basicform" data-parsley-validate="">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control form-control-sm">
                                                                            ...
                                                                            <?php foreach ($users_sub_menu_games as $key): ?>
                                                                                <option value="<?= $key['id_menu_games_sub_menu_games'] ?>"><?= $key['judul_sub_menu_games'] ?></option>
                                                                            <?php endforeach ?>
                                                                        </select>
                                                                    </div>
                                                                   ...
                                                                   <div class="form-group mt-2">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="inputLinkAsli">Link Asli</label>
                                                                        <input id="inputLinkAsli" type="text" name="link_asli" data-parsley-trigger="change" required="" autocomplete="off" class="form-control">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="inputLinkDemo">Link Demo</label>
                                                                        <input id="inputLinkDemo" type="text" name="link_demo"  required="" class="form-control">
                                                                    </div>
