                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">REKENING ANGGOTA </h2>
                                <p class="pageheader-text">Nulla euismod urna eros, sit amet scelerisque torton lectus vel mauris facilisis faucibus at enim quis massa lobortis rutrum.</p>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">REKENING ANGGOTA</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Rekening Anggota</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <header>
                                <!-- Button trigger modal -->
                                 <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#gamesModal">
                                            <i class="fas fa-plus-circle"></i> Tambah Rekening Anggota
                                        </a>
                                <!-- Modal -->
                            </header>
                            <div class="card-body">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="gamesModalLabel"><i class="fas fa-plus-circle"></i> Tambah Rekening Anggota</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form action="#" id="basicform" data-parsley-validate="">
                                                                    <div class="form-group">
                                                                        <label for="inputUserName">Anggota</label>
