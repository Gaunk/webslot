                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">REKENING </h2>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="gamesModalLabel"><i class="fas fa-plus-circle"></i> Tambah Rekening</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form action="#" id="basicform" data-parsley-validate="">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input id="inputNama" type="text" name="name" data-parsley-trigger="change" placeholder="Contoh : BCA" required="" autocomplete="off" class="form-control">
                                                                    </div>
                                                                </form>
